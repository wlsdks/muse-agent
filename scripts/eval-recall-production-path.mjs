...
export function renderSvg(result) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="640" viewBox="0 0 1000 640" role="img" aria-labelledby="title desc"><title id="title">Recall production-path evaluation</title><desc id="desc">Within-model pass counts out of twenty for ordinary correctness and confidence, absent abstention, correction pair retention, and current top-one through the production prepareGroundedRecall seam.</desc><style>text{font-family:Inter,ui-sans-serif,system-ui,sans-serif;fill:#172033}.title{font-size:25px;font-weight:760}.sub{font-size:12px;fill:#536075}.model{font-size:13px;font-weight:650}.value{font-size:10px}.b0{fill:#2563eb}.b1{fill:#0891b2}.b2{fill:#d97706}.b3{fill:#7c3aed}</style><rect width="1000" height="640" fill="#fff"/><text x="35" y="42" class="title">Recall production-path · ${result.payload.executionStatus}</text><text x="35" y="68" class="sub">topK 3 · refineChunks true · frozen synthetic v1 · four models × pass² · generative requests 0</text><text x="310" y="96" class="sub">Legend · blue ordinary · cyan absent · amber pair retained · purple current top-1</text>${rows}<text x="35" y="584" class="sub">agent aggregate FAILED · organic effectiveness NOT_PROVEN · repeats collapsed</text></svg>\n`;
}
