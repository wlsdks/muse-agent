...
export function renderSvg(result) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="780" viewBox="0 0 1200 780" role="img" aria-labelledby="title desc"><title id="title">Recall candidate-pool diagnostic</title><desc id="desc">Pair retention and correction-pass results for four local embedding models at top K four, eight, and twelve. A correction pass requires pair retention and current top-1.</desc><style>text{font-family:Inter,ui-sans-serif,system-ui,-apple-system,sans-serif;fill:#172033}.title{font-size:27px;font-weight:760}.sub{font-size:13px;fill:#536075}.model{font-size:12px;font-weight:650}.k{font-size:12px;fill:#536075}.value{font-size:10px}.footer{font-size:12px;font-weight:650}</style><rect width="1200" height="780" fill="#fff"/><text x="40" y="42" class="title">Recall candidate-pool diagnostic · ${result.payload.executionStatus}</text><text x="40" y="70" class="sub">local-live retrieval component · correction 20 · topK 4/8/12 · four models × two reliable trials · generative requests 0</text><rect x="350" y="91" width="14" height="9" fill="#0891b2"/><text x="372" y="100" class="sub">pair retained</text><rect x="480" y="91" width="14" height="9" fill="#94a3b8"/><text x="502" y="100" class="sub">raw correction pass</text><rect x="650" y="91" width="14" height="9" fill="#2563eb"/><text x="672" y="100" class="sub">Muse correction pass</text>${body}<line x1="40" y1="700" x2="1160" y2="700" stroke="#dce3ec"/><text x="40" y="728" class="footer">pass = pair retained + current top-1</text><text x="40" y="754" class="footer">diagnostic only · repeats collapsed · agent aggregate remains FAILED · organic effectiveness NOT_PROVEN</text></svg>\n`;
}
