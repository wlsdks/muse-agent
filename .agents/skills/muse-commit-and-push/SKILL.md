...
description: Use before committing, pushing, branching, or removing a worktree in the Muse repo — conventional-commit types, the required review-tier line and which diffs force an independent evaluator, the standing push authorization and everything it excludes, the rebase-before-push rule, and worktree lifecycle. Sending anything to a third party is not covered here; AGENTS.md governs that directly.
---

<!-- Generated by scripts/build-agents-md.mjs from .claude/rules/engineering/commits.md.
