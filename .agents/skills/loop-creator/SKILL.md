...
> `version` and adds a [`CHANGELOG.md`](../../../.claude/skills/loop-creator/CHANGELOG.md) entry; each journal entry
...
contract body is [`references/loop-engineering.md`](../../../.claude/skills/loop-creator/references/loop-engineering.md). This
