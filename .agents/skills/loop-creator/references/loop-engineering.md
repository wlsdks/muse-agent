...
> Where [`../../../../.claude/harness/dev-loop.md`](../../../../.claude/harness/dev-loop.md) covers *how to pick and execute one slice*,
...
| **Skill** | Reuse project knowledge (`SKILL.md`) — avoids re-deriving context every cycle | `.claude/skills/muse-dev-patterns`, [`../../../../.claude/harness/dev-loop.md`](../../../../.claude/harness/dev-loop.md) |
| **Connector** | *Actually act* on external tools (issue tracker · DB · Slack) via MCP | MCP (codegraph etc.), [`skills-and-mcp.md`](../../../../.claude/skills/loop-creator/references/skills-and-mcp.md) |
| **Sub-agent** | Agents with different instructions/models **separate ideation from verification** | harness planner→worker→evaluator ([`../../../../.claude/harness/roles.md`](../../../../.claude/harness/roles.md)), the Agent tool. **Fan out only for *context isolation / contamination avoidance*, never for raw parallelism**: at equal budget a single agent ≥ multi-agent (2604.02460); hand-off **topology strongly affects constraint survival** (linear chain > converging DAG — minority-source constraints get lost in synthesis — 2605.08647). Keep maker≠judge separation, but mindless fan-out is token waste. |
...
> ([`contract.md`](../../../../.claude/harness/contract.md) §4), an unattended fire may
...
3. **Implement maker ≠ judge with model tiers too — but Opus is the ceiling, so
   ...
   soft; skip it and maker≠judge collapses ([`../../../../.claude/harness/roles.md`](../../../../.claude/harness/roles.md)).
...
[`../../../../.claude/harness/contract.md`](../../../../.claude/harness/contract.md) §3 is the raw
...
1. **Unattended verification failure** — *"a loop that runs unattended is a
   ...
   ([`../../../../.claude/harness/roles.md`](../../../../.claude/harness/roles.md), agent-testing.md): the instance that
...
Adjacent contracts in this harness: [`../../../../.claude/harness/dev-loop.md`](../../../../.claude/harness/dev-loop.md) (slice selection/execution),
[`../../../../.claude/harness/roles.md`](../../../../.claude/harness/roles.md) (maker≠judge),
[`../../../../.claude/harness/contract.md`](../../../../.claude/harness/contract.md) (gates),
