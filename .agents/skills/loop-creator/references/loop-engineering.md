...
| **Skill** | Reuse project knowledge (`SKILL.md`) — avoids re-deriving context every cycle | `.claude/skills/` (improve-muse), [`../../../../.claude/harness/dev-loop.md`](../../../../.claude/harness/dev-loop.md) |
