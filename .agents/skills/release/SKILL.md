...
[`references/release-notes.md`](../../../.claude/skills/release/references/release-notes.md). Read it before
...
a breaking change) is [`references/release-notes.md` §A](../../../.claude/skills/release/references/release-notes.md#a-decide-the-number-deterministic).
...
2. **CHANGELOG** — analyse the **entire** commit history since the last tag and
   ...
   [`references/release-notes.md` §B](../../../.claude/skills/release/references/release-notes.md#b-write-the-notes-analyse-the-whole-history-since-the-last-tag):
...
- **Hit the A+ bar** in [`references/release-notes.md` §Quality bar](../../../.claude/skills/release/references/release-notes.md#quality-bar-what-a-means-here)
