...
description: Use when writing or reviewing Muse source for lint and comment policy — which ESLint rules are errors, how to promote a new one, naming, and the enforced ban on round/iteration/goal markers in comments. For where code should live, use muse-architecture instead.
---

<!-- Generated by scripts/build-agents-md.mjs from .claude/rules/engineering/code-style.md.
