...
- **Muse끼리 노하우 나눔(스웜 페더레이션)** — 여러 Muse 인스턴스가 또래끼리 연결돼 **배운 노하우(스킬·플레이북·패턴 틀)만** 주고받습니다. 노트·기억·과거 대화·연락처 같은 **개인 데이터는 종류 자체로 차단**되고, 내보내는 노하우도 개인정보·시크릿 검사를 거칩니다 — "노하우는 나누되 데이터는 안 나눈다".
