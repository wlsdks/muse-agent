...
status_legend:
  ...
  "⚠️": 알려진 갭(아직 신뢰도 부족)
updated: 2026-06-14
related: [FEATURES.md, README.md, feature-catalog/INDEX.md, strategy/differentiation.md]
---
...
기능적 차별점은 **"작업을 보여준다(shows its work)"** — 회상이든, 먼저 거는 말이든, 회고든 **모든 표면이 같은 그라운딩 게이트**를 거쳐, 진짜 출처를 인용하거나 "잘 모르겠다"로 내려가거나, 근거 없는 주장은 코드가 아예 버립니다(프라이버시는 바닥, 이건 그 위의 신뢰 장치 — [차별점](strategy/differentiation.md)).
