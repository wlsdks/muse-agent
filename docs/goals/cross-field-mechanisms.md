...
- [x] **C3 · Peak-end rule** (`peakEndDigest` — grounded no-LLM fallback when the summariser fails) (Kahneman et al. 1993) → `muse recap` stores an episode as its PEAK + END (cited), cheaper retrieval.
