...
| `agent-core-cognition` | agent-core 인지 코어 강화 (worktree `agent-core-enhance`) | [agent-core-cognition.md](agent-core-cognition.md) | 50 | `1030ef3a` | v1.14.0 | active (cron 42e5d7ba, session-only) |
