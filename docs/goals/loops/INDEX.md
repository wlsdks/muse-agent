...
| `context-strategy` | Context engineering — leanest sufficient context per turn (worktree `/tmp/muse-context-strategy`, branch `loop/context-strategy`) | [context-strategy.md](context-strategy.md) | 11 | `<commit-pending>` | v2.0.0 | active (cron `f7d80487`, session-only, Tier2 push+PR, merge-to-main every 5 fires) |
