...
|---|---|---|---|---|---|---|
| `tool-hardening` | TOOL expansion & hardening (main worktree) | [tool-hardening.md](tool-hardening.md) | 106 | `e874bb25` | v1.14.0 | active (cron, session-only) |
...
| `agent-core-cognition` | agent-core 인지 코어 강화 (worktree `agent-core-enhance`) | [agent-core-cognition.md](agent-core-cognition.md) | 32 | `a4ec4ada` | v1.14.0 | active (cron 42e5d7ba, session-only) |
...
| `codebase-quality` | 코드베이스 내부 품질 (decompose/cohere/dead-code/주석 · @muse/recall 추출) (worktree `codebase-quality`) | [codebase-quality.md](codebase-quality.md) | 66 | `8c0ac71b` | v1.14.0 | active (cron `725247c7`, session-only) |
