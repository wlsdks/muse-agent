...
| `self-improvement` | hermes-style 자기개선 머신러리 — Playbook RL · whetstone · Skill 작성 · Reflection/dreaming · memory consolidation (worktree `/tmp/muse-self-improvement`, branch `loop/self-improvement`, Tier1.5 local-main merge ea 3 fires) | [self-improvement.md](self-improvement.md) | 2 | `7b22ce7f` | v2.0.0 | active (cron `0b48bb96`, session-only) |
