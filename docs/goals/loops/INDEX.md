...
| `grounded-vision` | 근거-있는 비전/멀티모달 — 이미지→근거-추출→draft-first 액션 (worktree `/tmp/muse-grounded-vision`, branch `loop/grounded-vision`, Tier2 push, merge-based git) | [grounded-vision.md](grounded-vision.md) | 5 | `2f3e933a` | v2.0.0 | active (cron `abd98181`, session-only; replaces stopped paper-grounded) |
