...
const digest = createHash("sha256")
  .update("muse.attunement-graph.fair-witness-frontier-receipt.v1", "utf8")
  .update("\0", "utf8")
  .update(canonical(receiptBody), "utf8")
  .digest("hex");
assert.equal(
  result.frontier.receipt.receiptId,
  `muse-fair-witness-frontier-receipt:sha256:${digest}`
);
assert.equal(
  result.frontier.receipt.receiptId,
  "muse-fair-witness-frontier-receipt:sha256:aac7933d6f517f3a4d1df7f22386c04bfd756348e368c04d8548b86e7776c62b"
);
