...
const FORMAT = "muse-mag-portable";
const FORMAT_VERSION = 1;
const CANONICALIZATION = "muse-canonical-json-utf16@1";
const LIMITS_PROFILE = "mag-portable-limits@1";
const STATE_MODEL = "projection-journal-head@1";
const HASH_ALGORITHM = "sha-256";
const RECORD_DOMAIN = "muse.mag.portable-record.v1";
const STATE_DOMAIN = "muse.mag.portable-state.v1";
const STORE_DOMAIN = "muse.mag.store-projection.v1";
const RECORD_PREFIX = "mag-portable-record:";
const STATE_PREFIX = "mag-state:";
const STORE_PREFIX = "mag-store:";
...
const KNOWN_BYTES = Object.freeze({
  empty: 778,
  "one-scope-two-generations": 5_068
});
...
async function deriveCorpus(root) {
  ...
  return {
    ...
    manifest: {
      schemaVersion: 1,
      corpus: "muse-mag-portable-fixtures",
      corpusVersion: 1,
...
async function checkCorpus(root) {
  ...
  process.stdout.write(`verified MAG portable fixture corpus: ${actualRoot}\n`);
}
...
function parseMode(args) {
  ...
  fail(
    "usage: verify-mag-portable-fixtures.mjs "
