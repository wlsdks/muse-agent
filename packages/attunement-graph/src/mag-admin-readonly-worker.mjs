...
let database;
/** @type {ReturnType<typeof createMagAdminReadOnlyInspector> | undefined} */
let inspector;
...
function failureCode(cause) {
  return readMagAdminReadonlyInspectorFailure(cause) ?? "WORKER_FAILURE";
}
...
port.on("message", (value) => {
  ...
  try {
    if (request.type === "initialize") {
      ...
      inspector = createMagAdminReadOnlyInspector(database);
