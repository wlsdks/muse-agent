...
const objects = Object.freeze([
  Object.freeze({
    type: "index",
    name: "mag_projection_journal_generation",
    tableName: "mag_projection_journal",
    normalizedSql: normalizeSql(CREATE_GENERATION_INDEX)
  }),
  Object.freeze({
    type: "table",
    name: "mag_projection_head",
    tableName: "mag_projection_head",
    normalizedSql: normalizeSql(CREATE_HEAD)
  }),
  Object.freeze({
    type: "table",
    name: "mag_projection_journal",
    tableName: "mag_projection_journal",
...
export const MAG_PHYSICAL_SCHEMA_V1 = Object.freeze({
 ...
 * }} admittedProfile
 */
export function classifyMagPhysicalSchemaV1(admittedProfile) {
  if (
    admittedProfile.applicationId === MAG_PHYSICAL_SCHEMA_V1.applicationId
    && Number.isInteger(admittedProfile.userVersion)
    && admittedProfile.userVersion > MAG_PHYSICAL_SCHEMA_V1.userVersion
  ) return FUTURE;
  if (
    admittedProfile.applicationId !== MAG_PHYSICAL_SCHEMA_V1.applicationId
    || admittedProfile.userVersion !== MAG_PHYSICAL_SCHEMA_V1.userVersion
