...
/** @param {unknown} value @param {string} label @param {bigint} [minimum] @param {import("./mag-local-protocol.mjs").SerializedErrorCode} [code] */
...
/** @param {unknown} value @param {import("./mag-contracts.js").MagScope} scope */
...
/** @param {import("./mag-local-protocol.mjs").InitializePayload} payload @returns {Promise<import("./mag-local-protocol.mjs").InitializeResult>} */
async function initialize(payload) {
  ...
  try {
    ...
    try {
      ...
      if (cause instanceof Error && "magCode" in cause) throw cause;
...
/** @param {Record<string, unknown>} row @param {import("./mag-contracts.js").MagScope} scope */
...
/** @param {import("./mag-local-protocol.mjs").ReadPayload} payload @returns {import("./mag-local-protocol.mjs").ReadResult} */
...
/** @param {import("./mag-contracts.js").MagScope} scope @returns {import("./mag-contracts.js").MagSnapshot | undefined} */
...
/** @param {import("./mag-contracts.js").MagSnapshot | undefined} left @param {import("./mag-contracts.js").MagSnapshot | undefined} right */
...
/** @param {import("./mag-local-protocol.mjs").CompareAndSwapPayload} payload @returns {import("./mag-local-protocol.mjs").CompareAndSwapResult} */
...
/** @param {import("./mag-local-protocol.mjs").EmptyPayload} payload @returns {import("./mag-local-protocol.mjs").CloseResult} */
...
/** @param {import("./mag-local-protocol.mjs").HoldWriteLockPayload} payload @returns {import("./mag-local-protocol.mjs").HoldWriteLockResult} */
...
/** @param {import("./mag-local-protocol.mjs").EmptyPayload} payload @returns {import("./mag-local-protocol.mjs").InspectResult} */
...
/** @param {import("./mag-local-protocol.mjs").MutatePayload} payload @returns {import("./mag-local-protocol.mjs").MutateResult} */
...
/** @param {import("./mag-local-protocol.mjs").WorkerRequest} request @returns {Promise<import("./mag-local-protocol.mjs").WorkerResult>} */
