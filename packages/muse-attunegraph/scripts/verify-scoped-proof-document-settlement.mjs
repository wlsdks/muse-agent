...
const REQUEST = Object.freeze({
  domain: "muse.attunegraph.scoped-proof-document-settlement-request.v1",
  field: "requestId",
  prefix: "muse-attunegraph-scoped-proof-request:sha256:"
});
const DOCUMENT = Object.freeze({
  domain: "muse.attunegraph.scoped-proof-document.v1",
  field: "documentId",
  prefix: "muse-attunegraph-scoped-proof-document:sha256:"
});
const INVENTORY = Object.freeze({
  domain: "attunegraph.candidate-inventory.v1",
  field: "inventoryId",
  prefix: "attunegraph-candidate-inventory:sha256:"
});
const LEDGER = Object.freeze({
  domain: "attunegraph.candidate-settlement-ledger.v1",
  field: "ledgerId",
  prefix: "attunegraph-candidate-ledger:sha256:"
});
