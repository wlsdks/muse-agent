...
import type { SettlementAxis } from "@attunegraph/core/extension-kit";
import {
...
const RECEIPT_SPEC = Object.freeze({
  hashDomain: "muse.attunegraph.fair-witness-frontier-receipt.v1",
  idField: "receiptId",
  idPrefix: "muse-attunegraph-fair-witness-frontier-receipt:sha256:"
} as const);

const DOCUMENT_ID = /^muse-attunegraph-scoped-proof-document:sha256:[0-9a-f]{64}$/u;
const RECEIPT_ID = /^muse-attunegraph-fair-witness-frontier-receipt:sha256:[0-9a-f]{64}$/u;
