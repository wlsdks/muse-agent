...
const BINDING_RECEIPT_ID =
  /^muse-attunegraph-provider-bound-graph-evidence:sha256:[0-9a-f]{64}$/u;
...
const OMITTED_DIGEST =
  /^muse-attunegraph-provider-bound-omitted-assertion-ids:sha256:[0-9a-f]{64}$/u;
...
function canonicalOmittedIdsDigest(
  ...
  return `muse-attunegraph-provider-bound-omitted-assertion-ids:sha256:${
