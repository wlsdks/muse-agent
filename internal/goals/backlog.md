...
Full ranked list + sources: [`docs/strategy/competitor-analysis-and-a-plus-roadmap.md`](../../docs/strategy/competitor-analysis-and-a-plus-roadmap.md).
...
- [open] 2026-07-28 src=owner prio=1 for=improve-muse :: personal-agent Core100 실행: `personal-agent-core-100-roadmap.md`가 새 권위 문서다. 이미 닫힌 legacy 001–058과 현재 CLI actuator·permission repair 구현은 재사용하며 990분 Task 059–060은 실행하지 않는다. 각 activation은 active wall-clock 20분 이하이고, 다음 시작점은 Core100 Task 001 bounded input manifest다.
