...
2. **Fixed entry schema** (newest at bottom):
   ...
   ```
   The `meta:` line is **grep-able structured metadata** — the date / work (kind, value-class·pkg) /
   ...
   the mistake (ReasoningBank, §4.5-13) — omit it on a clean PASS. This is the "date / work / version" convention, formalized.
