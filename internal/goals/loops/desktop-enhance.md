...
browser-check: Automation view — tabs (action log/objectives/vetoes) render, raw i18n key leak 0, .content bounded+scroll, nav-icon 16px, new console errors 0 (badge text needs server data → covered by unit-test mapping)
