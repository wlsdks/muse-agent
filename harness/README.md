...
| [claude-code-integration.md](claude-code-integration.md) | **Claude Code 통합** — 서브에이전트·에이전트 팀·Dynamic Workflows + 오케스트레이션 선택 규약(그냥작업/서브/팀/워크플로) | draft |
| [claude-code-integration.md](claude-code-integration.md) | **Claude Code 통합** — 역할을 `.claude/agents/` 네이티브 서브에이전트로·병렬/순차·디스크 핸드오프·SubagentStop | draft |
