...
> **주의 — 이건 픽스처(시험 입력)이지 하네스 기능이 아닙니다.** 하네스는 규칙일 뿐 스스로 앱 코드를
> 짜지 않습니다. add·뒤집기·backoff 같은 과제는 "게이트/평가자/러너가 제대로 도는지" 확인하려고
> 통과시키는 **충돌 더미**일 뿐, 하네스가 하는 일이 아닙니다. 더미 내용이 앱 코드처럼 보여도 본질은
> 하네스의 자기검증 셋입니다.
