/**
 * The notes/tasks/calendar/reminders/followups/continuity read+write tool names an approval-gated
...
export const CHANNEL_APPROVAL_EXPOSURE_ALLOWLIST = [
  ...
  "muse.followup.list", "muse.followup.cancel", "muse.followup.snooze",
