...
function describeResidentDaemonHealthReason(
  ...
  const descriptions: Readonly<Record<ResidentDaemonHealthReasonCode, string>> = {
    ...
    [RESIDENT_DAEMON_HEALTH_REASON.heartbeatGenerationMismatch]: "heartbeat writer generation does not match resident authority",
    ...
    [RESIDENT_DAEMON_HEALTH_REASON.heartbeatProgressStale]: "heartbeat progress stale",
    ...
    [RESIDENT_DAEMON_HEALTH_REASON.restartBackoff]: "restart backoff active",
    [RESIDENT_DAEMON_HEALTH_REASON.restartCircuitHalfOpen]: "restart circuit half-open",
    [RESIDENT_DAEMON_HEALTH_REASON.restartCircuitOpen]: "restart circuit open",
    [RESIDENT_DAEMON_HEALTH_REASON.restartGenerationMismatch]: "restart successful generation mismatch",
    [RESIDENT_DAEMON_HEALTH_REASON.restartStateInvalid]: "restart state invalid",
    [RESIDENT_DAEMON_HEALTH_REASON.restartStateMissing]: "restart state missing",
    [RESIDENT_DAEMON_HEALTH_REASON.restartStateStale]: "restart state stale",
    [RESIDENT_DAEMON_HEALTH_REASON.restartStateUnverified]: "restart state unverified",
