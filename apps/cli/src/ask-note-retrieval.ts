...
import { diversifyAskChunks, filterNotesByScope, relativizeNoteSource, secondHopAugmentChunks, shouldSecondHop, type FileEntry, type IndexChunk } from "@muse/recall";
...
export async function retrieveAndRankNotes(params: {
  ...
  const { query, embedModel, indexFiles, notesDir, topK, scope, json, onStderr } = params;
