...
import { buildActionContextBlock, buildGitContextBlock, buildShellContextBlock, selectGroundingActions } from "@muse/recall";
...
export async function buildActivityGrounding(params: {
  ...
  const { query, embedModel, shell, git, actions } = params;
